...
import lyt.jingqi.badminton.util.JqBadmintonUtils;
...
public class UploadController {
    ...
    public Result upload (HttpServletRequest httpServletRequest,
        ...
        try {
            ...
            resultSuccess.setData(JqBadmintonUtils.getHost(new URI(httpServletRequest.getRequestURL() + "")) + "/uploadimg/" + newFileName);
