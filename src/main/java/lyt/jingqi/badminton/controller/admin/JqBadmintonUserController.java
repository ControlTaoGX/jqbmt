...
public class JqBadmintonUserController {
    ...
    public String usersPage(HttpServletRequest request) {
        ...
        return "admin/jq_badminton_user";
    }
    ...
    public Result list(@RequestParam Map<String, Object> params) {
        ...
        return ResultGenerator.genSuccessResult(jqBadmintonUserService.getJqBadmintonUsersPage(pageUtil));
    }
    ...
    public Result delete(@RequestBody Integer[] ids, @PathVariable int lockStatus) {
        ...
        if (jqBadmintonUserService.lockUsers(ids, lockStatus)) {
